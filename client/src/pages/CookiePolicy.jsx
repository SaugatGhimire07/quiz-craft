  ...
  return (
    <div className="cookie-policy">
      ...
      <section>
        ...
        <p>
          Quiz Craft Platform uses cookies and similar tracking technologies to
          enhance user experience and analyze platform usage. This Cookie Policy
      ...
      <section>
        ...
        <p>
          ...
          website. They help improve functionality, remember preferences, and
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            functionality of the platform, such as user authentication and
            security.
          </li>
          <li>
            <strong>Performance Cookies:</strong> Help us analyze site traffic
            and understand user interactions to improve the platform.
          </li>
          <li>
            <strong>Functional Cookies:</strong> Allow us to remember user
            preferences, such as language and quiz settings.
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          However, disabling certain cookies may impact platform functionality.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Some third-party services, such as analytics and advertising
      ...
      <p>
        By using Quiz Craft Platform, you consent to our use of cookies as
